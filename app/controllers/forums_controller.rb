class ForumsController < ApplicationController
  def show
    ...
    Tagging.select("id as 'id', taggable_id as 'taggable_id', tag_id as 'tag_id', tagger_id as 'tagger_id', tagger_type as 'tagger_type',max(created_at) as 'created_at',taggable_type as 'taggable_type',context as 'context'")
